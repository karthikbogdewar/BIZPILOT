...
export default function Sidebar({
  ...
  return (
    <aside className="w-60 bg-surface-900/95 border-r border-slate-800/80 flex flex-col justify-between h-screen shrink-0 overflow-y-auto">
      <div>
        {/* Brand Header */}
        <div className="p-4 border-b border-slate-800/80 flex items-center gap-3">
          ...
          <div>
            <div className="font-bold text-sm tracking-tight text-white flex items-center gap-1.5">
              BizPilot AI
              <span className="bg-brand-500/20 text-brand-300 text-[10px] px-1.5 py-0.2 rounded font-mono font-bold uppercase border border-brand-500/30">Ops</span>
            </div>
